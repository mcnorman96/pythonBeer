...
def test_all_events_success(client, mocker):
    ...
    mocker.patch('services.event_services.EventService.get_all', return_value=mock_events)
...
def test_get_event_by_id_success(client, mocker):
    ...
    mocker.patch('services.event_services.EventService.get_by_id', return_value=mock_event)
...
def test_get_event_by_id_error(client, mocker):
    mocker.patch('services.event_services.EventService.get_by_id', side_effect=ValueError('DB error'))
